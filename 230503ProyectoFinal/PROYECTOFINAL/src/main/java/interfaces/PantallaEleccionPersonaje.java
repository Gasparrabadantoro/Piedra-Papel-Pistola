	...
	public PantallaEleccionPersonaje(Ventana v) {
		...
		imagenMomia.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				v.cambiarAPantalla(PantallaPartida.class, v.personaje, null);
			}
		});
